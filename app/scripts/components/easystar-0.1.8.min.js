...
var MinimalDistanceToTarget = 1000000000000000000000000;
...
EasyStar.js = function() {
    ...
    this.calculate = function() {
        ...
        for (iterationsSoFar = 0; iterationsSoFar < iterationsPerCalculation; iterationsSoFar++) {
            ...
            if (instances[0].openList.length===0) {
                ...
                var x = instances[0].startX;
                var y = instances[0].startY;
                //instances[0].callback(null);

                this.findPath(x, y,  lastPosXY.x, lastPosXY.y,instances[0].callback)
                instances.shift();
    ...
    var coordinateToNode = function(instance, x, y, parent, cost) {
        ...
        if(simpleDistanceToTarget < MinimalDistanceToTarget)
        {
            MinimalDistanceToTarget = simpleDistanceToTarget;
            lastPosXY = {x: x, y: y};
        }
